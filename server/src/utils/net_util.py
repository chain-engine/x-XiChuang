...
if __name__ == '__main__':
    print(NetUtil.get_hostname())

    print(NetUtil.get_ip_network("192.168.100.152"))
    print(NetUtil.is_ip_network("192.168.100.152"))

    print(NetUtil.get_hostname_by_ip("127.0.0.1"))
    print(NetUtil.get_hostname_by_ip("192.168.100.152"))

    print(NetUtil.get_ip_by_hostname("localhost"))

    print(NetUtil.is_ip_reachable("192.168.100.151"))
    print(NetUtil.is_ip_port_reachable("192.168.100.151", 22))
    print(NetUtil.is_ip_port_reachable("192.168.100.151", 2211))

    print(NetUtil.is_valid_ip("192.168.100.151"))
    print(NetUtil.is_valid_mac("10:7B:44:80:F4:6A"))

    print(NetUtil.ignore_ssl())
    print(NetUtil.get_mac_address("192.168.110.167"))
    print(NetUtil.get_ip_address())
