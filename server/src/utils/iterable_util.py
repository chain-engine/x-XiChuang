...
if __name__ == '__main__':
    print(IterableUtil.is_iterator_empty(range(6)))
    print(IterableUtil.is_iterator_empty(range(0)))
    print(IterableUtil.is_iterator((x for x in range(6))))
    print(IterableUtil.is_iterable((x for x in range(6))))
    print(IterableUtil.is_iterable_empty(range(5)))
