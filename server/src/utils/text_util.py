...
if __name__ == '__main__':
    print(TextUtil.is_str(u"xxx"))
    print(TextUtil.is_contains_chinese("我们中国ss"))
    print(TextUtil.is_all_chinese("我们中国ss"))
    print(TextUtil.is_contains_chinese("ss"))
    print(TextUtil.is_all_chinese("ss"))
    print(TextUtil.calculate_crc32("106.75.54.33"))
    print(TextUtil.calculate_crc32("2.57.122.123"))
    print(TextUtil.calculate_md5("2.57.122.123"))
    print(TextUtil.calculate_sha1("2.57.122.123"))
    print(TextUtil.calculate_sha256("2.57.122.123"))
    print(TextUtil.is_md5_value("7daad22ca20b7fef23fea40ba37d0315"))
    print(TextUtil.is_sha256_value("045bb77ae9f41e4e8df7681af68c7ad4ede3ebc27dbd9dfbf79e3bdc674023f3"))
